                    ...
                    @if($i%2 !== 0 )
                        <div class="row mb-2 border border-dark rounded">
                            ...
                            <div class="col-9">
                                ...
                                <p class="text-muted font-weight-lighter m-0" style="font-size: 0.8rem;">Publicado em {{ \Carbon\Carbon::parse($post->created_at)->format('d/m/Y h:i:s') }} {{ \Carbon\Carbon::parse($notice->created_at)->diffForHumans() }}</p>
                                <hr class="m-0">
